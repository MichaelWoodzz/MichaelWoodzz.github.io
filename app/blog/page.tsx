...
export default function BlogIndex() {
  ...
  return <>
    ...
    <header className="site-header detail-header"><SiteLink className="wordmark" href="/">vantage<span>.</span></SiteLink><nav aria-label="Main navigation"><SiteLink href="/about/">About</SiteLink><SiteLink href="/services/">What I do</SiteLink><SiteLink href="/blog/" aria-current="page">Field Notes</SiteLink><SiteLink href="/#apply">Let’s talk <ArrowUpRight size={15} aria-hidden="true" /></SiteLink></nav></header>
    <main id="main" className="blog-index">
      ...
      <section className="blog-closing"><p className="eyebrow">Need more than an article?</p><h2>The ideas are here. Let’s make them your life.</h2><SiteLink className="primary-link" href="/#apply">Let’s make it happen <ArrowUpRight size={18} /></SiteLink></section>
    </main>
    <SiteLink className="floating-apply" href="/#apply">Let’s talk <ArrowUpRight size={17} /></SiteLink>
