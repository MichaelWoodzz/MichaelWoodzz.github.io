...
export default function Home() {
  return (
    <>
      ...
      <main id="main">
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            ...
            <div className="hero-actions"><SiteLink className="primary-link" href="#apply">Get Vantage in your corner <ArrowUpRight size={20} aria-hidden="true" /></SiteLink><SiteLink className="hero-text-link" href="#advisory">What does a private wingman do?</SiteLink></div>
            <div className="hero-bottom"><span>25+ men helped · LA-based · Completely private</span><SiteLink href="#apply" aria-label="Go to the private application"><ArrowDown size={20} aria-hidden="true" /></SiteLink></div>
          </div>
        ...
        <section className="fit section-shell" id="fit" aria-labelledby="fit-title">
          ...
          <SiteLink className="primary-link fit-cta" href="#apply">Tell me what is not working <ArrowUpRight size={18} aria-hidden="true" /></SiteLink>
        </section>
        ...
        <section className="consulting section-shell" id="services" aria-labelledby="consulting-title">
          ...
          <div className="services services-four">
            <article className="service"><span className="service-number">01</span><h3>Look your best</h3><p>We help you improve your physique, hair, skin, grooming, wardrobe, photos, and overall presentation—with excellent specialists from our private network.</p><span className="service-topics">Physique · Hair · Skin · Style · Photos</span><SiteLink className="service-detail-link" href="/mens-image-consulting-los-angeles/">Explore appearance advisory <ArrowUpRight size={14} aria-hidden="true" /></SiteLink></article>
            <article className="service"><span className="service-number">02</span><h3>Date better</h3><p>We improve your confidence, conversation, dating strategy, apps, photos, prompts, and messaging so you present yourself naturally and effectively.</p><span className="service-topics">Confidence · Strategy · Apps · Conversation</span><SiteLink className="service-detail-link" href="/private-dating-advisor-los-angeles/">Explore dating advisory <ArrowUpRight size={14} aria-hidden="true" /></SiteLink></article>
            <article className="service"><span className="service-number">03</span><h3>Build your social life</h3><p>We help you make better friends, find the right places, fill your calendar, and create a lifestyle that makes meeting people a normal part of your week.</p><span className="service-topics">Friends · Places · Plans · Introductions</span><SiteLink className="service-detail-link" href="/social-life-consulting-los-angeles/">Explore social advisory <ArrowUpRight size={14} aria-hidden="true" /></SiteLink></article>
            <article className="service"><span className="service-number">04</span><h3>Go out together</h3><p>We can join you at bars, dinners, clubs, and events, help with introductions, and give you useful feedback while the experience is still fresh.</p><span className="service-topics">Outings · Introductions · Support · Feedback</span><SiteLink className="service-detail-link" href="/private-wingman-los-angeles/">Explore in-person support <ArrowUpRight size={14} aria-hidden="true" /></SiteLink></article>
          </div>
        </section>
        ...
        <section className="process-conversion section-shell" id="process" aria-labelledby="process-title">
          ...
          <SiteLink className="primary-link" href="#apply">Tell me what you need <ArrowUpRight size={18} aria-hidden="true" /></SiteLink>
        </section>
        ...
        <section className="faq section-shell" aria-labelledby="faq-title">
          ...
          <div className="faq-list">
            ...
            <article><h3>Should I hire a dating coach, a matchmaker, or Vantage?</h3><p>A coach usually focuses on skills, while a matchmaker focuses on introductions. Vantage works on the full picture and can be beside you in real life. <SiteLink className="inline-link" href="/dating-coach-vs-matchmaker-los-angeles/">Compare the options</SiteLink>.</p></article>
        ...
        <section className="home-blog section-shell" aria-labelledby="home-blog-title">
          ...
          <div className="home-blog-grid">{blogPosts.slice(0, 3).map((post, index) => <article key={post.slug}><span>{String(index + 1).padStart(2, '0')} / {post.category}</span><h3><SiteLink href={`/blog/${post.slug}/`}>{post.title}</SiteLink></h3><p>{post.description}</p><SiteLink href={`/blog/${post.slug}/`}>Read the guide <ArrowUpRight size={15} aria-hidden="true" /></SiteLink></article>)}</div>
          <SiteLink className="all-notes-link" href="/blog/">See all field notes <ArrowUpRight size={16} aria-hidden="true" /></SiteLink>
        </section>
      ...
      <footer className="site-footer site-footer-expanded"><SiteLink className="wordmark" href="/" aria-label="Vantage home">vantage<span>.</span></SiteLink><nav className="footer-links" aria-label="Footer navigation"><SiteLink href="/about/">About</SiteLink><SiteLink href="/services/">Services</SiteLink><SiteLink href="/blog/">Field Notes</SiteLink><SiteLink href="/how-it-works/">How it works</SiteLink><SiteLink href="/southern-california-service-area/">Service area</SiteLink><SiteLink href="/privacy/">Privacy</SiteLink><SiteLink href="#apply">Let’s talk</SiteLink></nav><p>Los Angeles · Orange County · Ventura County</p><span>© {new Date().getFullYear()} Vantage</span></footer>
    </>
  );
}
