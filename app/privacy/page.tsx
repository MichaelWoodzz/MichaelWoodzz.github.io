    ...
    <>
      ...
      <main id="main" className="detail-page policy-page">
        ...
        <div className="detail-content policy-content">
          ...
          <section className="detail-section"><p className="detail-number">04</p><div><h2>Your choices</h2><p>You may ask Vantage to correct or delete personal information you previously sent by contacting <a className="inline-link" href="mailto:michael@vantagesocal.com">michael@vantagesocal.com</a>.</p><p>This notice may be updated as the site or service changes. The current version was published September 9, 2026.</p></div></section>
        </div>
      </main>
      <footer className="site-footer"><Link className="wordmark" href="/" aria-label="Vantage home">vantage<span>.</span></Link><p>Los Angeles · Orange County · Ventura County</p><span>© {new Date().getFullYear()} Vantage</span></footer>
    </>
  );
}
