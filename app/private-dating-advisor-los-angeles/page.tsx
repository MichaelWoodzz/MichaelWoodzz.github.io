...
export const metadata: Metadata = {
  ...
  description: 'Private, hands-on dating advisory for accomplished men in Los Angeles. Improve confidence, conversation, profiles, photos, strategy, and real-world opportunities.',
  alternates: { canonical: '/private-dating-advisor-los-angeles/' },
  openGraph: { title: 'Private Dating Advisor for Men in Los Angeles | Vantage', description: 'Personal dating strategy and hands-on support for accomplished men across Los Angeles and Southern California.', url: '/private-dating-advisor-los-angeles/' },
};
...
export default function Page() {
  return <AdvisoryDetailPage
    ...
    lead="Vantage helps accomplished men improve how they date—from confidence and conversation to profiles, photos, social opportunities, and the choices that shape each experience."
